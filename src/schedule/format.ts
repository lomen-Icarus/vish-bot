 ...
 * «Фамилия И. О.» превратило бы в кашу. Ставит её только groupsAsLabel в
 * render/themes.ts на входе в отрисовку (labels: "groups"); в данные
 * расписания она не попадает. Все темы рисуют строку через posterTeacher.
 */
const LITERAL = "\u2063";
